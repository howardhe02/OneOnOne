...
const NewMeeting = ({ BACKENDURL, closePopup }) => {
            ...
            <div>
                <div id="popup">
                    <div id='close-btn-container'>
                        <button id="close-new-meeting" onClick={closePopup}>X</button>
                    </div>
                    <div id="contents">
                        <div id="form-column">
                            <form>
                                <h1 class="col-blue">New Meeting</h1>
                    ...
                    <div id="close-btn-container">
                        <div id="submit_msg" style={{ fontSize: "small", fontStyle: "italic" }}></div>
